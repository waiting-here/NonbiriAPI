...
var generationTwoWithoutNineSeatsSchema = gatewayBootstrapSchema(generationTwoWithoutGatewaySchema)
var generationTwoSchema = blackjackNineSeatBootstrapSchema(generationTwoWithoutNineSeatsSchema)
