...
func buildGenerationTwoConfigCatalog() map[string]generationTwoConfigSpec {
	...
	catalog := map[string]generationTwoConfigSpec{
		...
		"level_display_name_5":              {kind: generationTwoConfigLevelName, seed: generationTwoSeed("见习协管"), maxRunes: 64, allowEmpty: true},
		...
		"game_fishing_blue_fish_chance_bps": uintSpec("1000", 0, 10000),
