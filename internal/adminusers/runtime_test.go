...
func TestRegisterRoutesOwnsOnlyFrozenCorrectiveSurface(t *testing.T) {
	...
	if len(fixture.registrar.routes) != 13 {
	...
	want := map[string]bool{
		...
		"GET " + routeUserPenalties:                                           true,
		"GET " + routeUserPenalties + "/{caseId}":                             true,
		"GET " + routeUserPenalties + "/{caseId}/actions/{actionId}/evidence": true,
	}
