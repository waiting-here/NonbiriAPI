// Package useractivity stores authoritative active-action facts in business transactions.
...
var ErrInvalid = errors.New("useractivity: invalid input")

// Leave room for the longest account-policy audit retention interval.
func validTime(at int64) bool { return at >= 0 && at <= 253402300799-400*86400 }
