...
func recoveryAdaptersWithRecorder(record func(string)) RecoveryAdapters {
	...
	return RecoveryAdapters{
		...
		Bidding: makeAdapter("bidding"), Likes: makeAdapter("likes"),
	}
}
...
func TestMaintenanceRunsFrozenRecoveryThenRetentionOrder(t *testing.T) {
	...
	want := []string{
		...
		"recovery:fishing", "recovery:linklink", "recovery:rps", "recovery:bidding", "recovery:likes", "recovery:donations", "recovery:secrets",
		"retention:sessions", "retention:request_logs", "retention:audits", "retention:issues", "retention:fishing",
		"retention:linklink", "retention:rps", "retention:bidding", "retention:likes", "retention:reports", "retention:donations", "retention:charity",
