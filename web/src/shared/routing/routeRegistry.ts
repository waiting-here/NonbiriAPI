...
const user = (descriptor: Omit<RouteDescriptor, 'station'>): RouteDescriptor => ({
  ...descriptor,
  station: 'user',
});
const admin = (descriptor: Omit<RouteDescriptor, 'station'>): RouteDescriptor => ({
  ...descriptor,
  station: 'admin',
});
...
export const USER_ROUTE_DESCRIPTORS = [
  ...
  user({
    ...
    registered: true,
    icon: 'resources',
    labelKey: 'user.resources.nav',
    fallbackLabelKey: 'user.endpoints.nav',
  }),
  user({
    id: 'endpoint-detail',
  ...
  user({
    ...
    registered: true,
    icon: 'charity',
    labelKey: 'user.charity.nav',
  }),
  user({
    id: 'donation-detail',
    path: '/charity/donations/:donationId',
    access: 'user',
    layout: 'readable',
    registered: true,
  }),
  user({
    ...
    registered: true,
    icon: 'activities',
    labelKey: 'user.activities.nav',
    fallbackLabelKey: 'user.games.nav',
  }),
  user({
    id: 'games',
    path: '/games',
    ...
    registered: true,
    icon: 'games',
    labelKey: 'user.games.nav',
  }),
  user({
    id: 'picture-book',
    path: '/activities/picture-book',
    access: 'user',
    layout: 'wide',
    registered: true,
  }),
...
export const ADMIN_ROUTE_DESCRIPTORS = [
  admin({
    id: 'admin-inactivity-policy',
    path: '/inactivity-policy',
    access: 'admin',
    layout: 'wide',
    nav: true,
    registered: true,
    navGroup: 'users',
    icon: 'users',
    labelKey: 'common.activities.inactivity',
  }),
  admin({
    id: 'admin-limited-activities',
    path: '/limited-activities',
    access: 'admin',
    layout: 'wide',
    nav: true,
    registered: true,
  ...
  admin({
    ...
    fallbackLabelKey: 'admin.games.nav',
  }),
  admin({
    id: 'admin-games',
    path: '/games',
  ...
  admin({
    ...
    fallbackLabelKey: 'admin.alerts.nav',
  }),
  admin({
