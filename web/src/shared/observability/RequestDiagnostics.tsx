  ...
  return (
    <div className="request-diagnostics">
      {synthetic && (
        <p role="status">
          {words(
            'This is a safe diagnostic summary generated by the site, not the original upstream body. Image-bearing content was omitted.',
            '这是本站生成的安全诊断摘要，不是上游原始正文；可能含图片的内容已省略。',
          )}
        </p>
      )}
      {body.truncated && (
