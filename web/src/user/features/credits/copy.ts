...
const en = {
  ...
  records: 'records',
  note: 'Funds set aside for calls, games and image generation appear as outflows. Refunds appear as separate entries. Each asset is shown separately.',
  checkin: 'Check-in',
...
const zh: typeof en = {
  ...
  records: '条记录',
  note: '调用、游戏和图像生成预扣的积分或活动币会先记为支出，退款另列记录。各种资产分别显示。',
  checkin: '签到',
  welfare: '低保池',
  thursday: '疯狂星期四',
  fishing: '池塘垂钓',
...
const reasons: Record<HistoryKind, [string, string]> = {
  ...
  game_onboarding_reward: ['游戏新人奖励', 'Game newcomer reward'],
  activity_loan: ['赛博网贷', 'Cyber loan'],
  ...
  activity_exchange: ['活动币兑换', 'Activity currency exchange'],
  image_reserve: ['图像生成：预扣', 'Image generation: funds reserved'],
  image_settle: ['图像生成：结算', 'Image generation: charged'],
  image_refund: ['图像生成：退款', 'Image generation: refund'],
  image_delete_finalize: ['图像生成：删号结清', 'Image generation: account closure settlement'],
  inactivity_decay: ['低活跃积分衰减', 'Inactivity credit decay'],
};
