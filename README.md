...
>
> **Compatibility boundary:** Generation 2 (`application_id=0x4E425249`, `user_version=2`), targeting Linux/amd64. Complete beta.4, both preceding development schemas and eleven exact earlier manifests support atomic upgrades to 117 tables, preserving existing data and configuration. The three new games start disabled. Alpha/Generation 1 still requires an explicit fresh cutover. See the [deployment guide](docs/deployment.md#database-compatibility-and-version-changes).
>
