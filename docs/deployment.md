...
6. Point `/opt/nonbiriapi/current` at the new compatible release and start the service:
   ...
   ```sh
   version=1.0.0-beta.2  # replace with the compatible release being installed
