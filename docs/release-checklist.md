...
- [ ] Test each of the four explicitly supported earlier Generation 2 manifests and the exact deployed intermediate manifest through its additive update and a second normal startup; verify that accounts, resources, balances, settings, routing choices, key limits, and historical facts are preserved.
